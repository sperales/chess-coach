...
## Current baseline — v1.2.8

v1.2.8 moves exercise solving to a dedicated Training Center page with a focused board layout, exercise metadata, session metrics and a refreshed training hero background.
