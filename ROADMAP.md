...
Current stable baseline: **v1.2.6**
...
## Current baseline — v1.2.6

v1.2.6 polishes the home summary, review quick insights and games list UI while keeping the first Openings Lab release line stable.
