...
Current stable baseline: **v1.2.4**
...
## Current baseline — v1.2.4

v1.2.4 polishes the review and home dashboard experience while keeping the first Openings Lab release line stable.
