...
Current stable baseline: **v1.2.5**
...
## Current baseline — v1.2.5

v1.2.5 refreshes the review page hero, evaluation chart and bottom insights while keeping the first Openings Lab release line stable.
