...
CREATE TABLE IF NOT EXISTS game_analysis (
  ...
  engine_build VARCHAR(80) DEFAULT NULL,
  engine_depth INT UNSIGNED DEFAULT NULL,
  engine_threads SMALLINT UNSIGNED DEFAULT NULL,
  engine_hash_mb INT UNSIGNED DEFAULT NULL,
  engine_search_mode ENUM('depth','movetime','adaptive_nodes') DEFAULT NULL,
  engine_search_value INT UNSIGNED DEFAULT NULL,
  engine_secondary_search_value INT UNSIGNED DEFAULT NULL,
  engine_evaluations INT UNSIGNED NOT NULL DEFAULT 0,
  engine_deep_evaluations INT UNSIGNED NOT NULL DEFAULT 0,
  engine_retry_count INT UNSIGNED NOT NULL DEFAULT 0,
  engine_nodes BIGINT UNSIGNED NOT NULL DEFAULT 0,
  engine_time_ms BIGINT UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS game_move_analysis (
  ...
  bestmove_after VARCHAR(10) DEFAULT NULL,
  score_before INT DEFAULT NULL,
  score_before_type ENUM('cp','mate') DEFAULT NULL,
  score_after INT DEFAULT NULL,
  score_after_type ENUM('cp','mate') DEFAULT NULL,
  depth_before SMALLINT UNSIGNED DEFAULT NULL,
  depth_after SMALLINT UNSIGNED DEFAULT NULL,
  seldepth_before SMALLINT UNSIGNED DEFAULT NULL,
  seldepth_after SMALLINT UNSIGNED DEFAULT NULL,
  nodes_before BIGINT UNSIGNED DEFAULT NULL,
  nodes_after BIGINT UNSIGNED DEFAULT NULL,
  time_before_ms INT UNSIGNED DEFAULT NULL,
  time_after_ms INT UNSIGNED DEFAULT NULL,
  nps_before BIGINT UNSIGNED DEFAULT NULL,
  nps_after BIGINT UNSIGNED DEFAULT NULL,
  hashfull_before SMALLINT UNSIGNED DEFAULT NULL,
  hashfull_after SMALLINT UNSIGNED DEFAULT NULL,
  pv_before_uci TEXT DEFAULT NULL,
  pv_after_uci TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS training_exercises (
  ...
  KEY idx_training_exercises_opportunity (opportunity_id),
...
CREATE TABLE IF NOT EXISTS training_sessions (
  ...
  coach_version SMALLINT UNSIGNED NOT NULL DEFAULT 1,
  coach_focus_code VARCHAR(60) DEFAULT NULL,
  coach_focus_title VARCHAR(160) DEFAULT NULL,
  coach_rationale VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS training_scenarios (
  ...
  KEY idx_training_scenarios_opportunity (opportunity_id),
...
CREATE TABLE IF NOT EXISTS training_session_items (
  ...
  selection_reason_code VARCHAR(60) DEFAULT NULL,
  ...
  KEY idx_training_session_items_opportunity (opportunity_id),
  ...
  CONSTRAINT fk_training_session_items_scenario FOREIGN KEY (scenario_id) REFERENCES training_scenarios(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS training_scenario_runs (
  ...
  first_move_at TIMESTAMP NULL DEFAULT NULL,
  time_to_first_move_ms INT UNSIGNED DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS training_solve_runs (
  ...
  KEY idx_training_solve_runs_session_item (session_item_id),
  ...
  CONSTRAINT fk_training_solve_runs_session_item FOREIGN KEY (session_item_id) REFERENCES training_session_items(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS training_coach_messages (
  ...
  coach_state ENUM('welcome','neutral','idle','thinking','explaining','correct','error','hint','session_complete') NOT NULL DEFAULT 'idle',
...
CREATE TABLE IF NOT EXISTS training_attempts (
  ...
  KEY idx_training_attempts_solve_run (solve_run_id, created_at),
...
('1.4.12', 'Training progress, autonomy and personalized plan foundation'),
('1.4.16', 'Stockfish 18 identity, full-history analysis and engine telemetry'),
('1.5.0', 'Coach foundation, ordered Training v2 plans and semantic Coach feed'),
('1.5.0-scenarios', 'Training v2 scenarios, execution history and interactive Stockfish cache'),
('1.6.0-training-quality-foundation', 'Taxonomy, canonical opportunities, shadow selection, mastery and Coach Decision foundation')
