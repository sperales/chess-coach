...
- v1.4.11 — SAN notation for training exercises (completed)
- v1.4.12 — Training plans, progressive hints and performance tracking (completed)
...
- v1.5.1 — Review variations, analysis board and realtime Scenarios (release candidate)
- v1.6.0 — AI Coach MVP
